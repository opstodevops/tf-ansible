...
module "rds" {
  ...
  name                   = "ops2devappdb"
  username               = "ops2devadmin"
  password               = "YourPwdShouldBeLongAndSecure!" # Look for secret management solution
  port                   = "3306"
  ...
  final_snapshot_identifier = "ops2dev-app-db"
